System.register(["angular2/core", "./daily-form.component", "./monthly-form.component", "./login.component", "./create-user.component", "./account-info.component", "./account.service", "./nav.component", "angular2/router"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, daily_form_component_1, monthly_form_component_1, login_component_1, create_user_component_1, account_info_component_1, account_service_1, nav_component_1, router_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
